  ...
  return (
    <>
      ...
      <section className="profile-hero brk" style={{
        ...
        // Reserve room so a long name never slides under the corner gear.
        paddingRight: isSelf ? 56 : undefined,
      }}>
        <span className="br-tr" />
        <span className="br-bl" />
        {isSelf && (
          <Link href="/settings" className="profile-gear" aria-label="Settings">
