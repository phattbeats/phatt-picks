 ...
 * ROSTER (active five), and the THREE most recent official matches. Sourced from
...
export const TEAM_STATS_AS_OF = "2026-06-01"; // HLTV world ranking + recent results snapshot
...
export interface TeamStats {
  ...
  recent: RecentMatch[]; // most-recent first, up to 3
}
...
export const TEAM_STATS: Record<number, TeamStats> = {
  ...
  48: { // Liquid
    ...
    recent: [
      ...
      { date: "19/05/2026", opponent: "PARIVISION", score: "9-13", result: "L" },
    ],
  },
  59: { // G2
    worldRank: 14,
  ...
  69: { // BIG
    ...
    recent: [
      ...
      { date: "24/04/2026", opponent: "Acend", score: "2-0", result: "W" },
    ],
  },
  74: { // TYLOO
    worldRank: 29,
    ...
    recent: [
      ...
      { date: "21/05/2026", opponent: "paiN", score: "1-2", result: "L" },
    ],
  },
  80: { // MIBR
    worldRank: 19,
    ...
    recent: [
      ...
      { date: "21/05/2026", opponent: "B8", score: "2-1", result: "W" },
    ],
  },
  81: { // Spirit
    worldRank: 3,
  ...
  87: { // NRG
    ...
    recent: [
      ...
      { date: "12/05/2026", opponent: "FaZe", score: "0-2", result: "L" },
    ],
  },
  89: { // Vitality
    worldRank: 1,
  ...
  95: { // HEROIC
    ...
    recent: [
      ...
      { date: "12/05/2026", opponent: "magic", score: "1-2", result: "L" },
    ],
  },
  102: { // paiN
    worldRank: 18,
  ...
  104: { // Sharks
    ...
    recent: [
      ...
      { date: "28/05/2026", opponent: "Ninjas in Pyjamas", score: "0-2", result: "L" },
    ],
  },
  106: { // MOUZ
    worldRank: 8,
  ...
  115: { // GamerLegion
    ...
    recent: [
      ...
      { date: "15/05/2026", opponent: "paiN", score: "2-1", result: "W" },
    ],
  },
  119: { // Monte
    worldRank: 24,
  ...
  127: { // Lynn Vision
    ...
    recent: [
      ...
      { date: "20/05/2026", opponent: "The MongolZ", score: "3-13", result: "L" },
    ],
  },
  132: { // FlyQuest
    worldRank: 81,
    ...
    recent: [
      ...
      { date: "11/05/2026", opponent: "JiJieHao", score: "1-2", result: "L" },
    ],
  },
  134: { // Aurora
    worldRank: 6,
  ...
  135: { // B8
    ...
    recent: [
      ...
      { date: "20/05/2026", opponent: "The MongolZ", score: "2-1", result: "W" },
    ],
  },
  137: { // BetBoom
    worldRank: 21,
    ...
    recent: [
      ...
      { date: "13/05/2026", opponent: "paiN", score: "2-1", result: "W" },
    ],
  },
  139: { // Falcons
    worldRank: 4,
  ...
  140: { // M80
    ...
    recent: [
      ...
      { date: "21/05/2026", opponent: "MOUZ", score: "1-2", result: "L" },
    ],
  },
  142: { // PARIVISION
    worldRank: 11,
  ...
  146: { // Gaimin Gladiators
    ...
    recent: [
      ...
      { date: "05/04/2026", opponent: "paiN", score: "1-3", result: "L" },
    ],
  },
  147: { // SINNERS
    worldRank: 30,
    ...
    recent: [
      ...
      { date: "13/05/2026", opponent: "Passion UA", score: "2-1", result: "W" },
      { date: "11/05/2026", opponent: "GamerLegion", score: "1-2", result: "L" },
    ],
  },
  148: { // THUNDER dOWNUNDER
    ...
    recent: [
      ...
      { date: "14/05/2026", opponent: "Kaleido", score: "2-1", result: "W" },
    ],
  },
};
